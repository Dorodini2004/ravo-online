  ...
  return (
    <main className="ravo-felt relative min-h-screen overflow-x-clip px-6 py-8 text-white">
      ...
      <div className="pointer-events-none absolute inset-0 opacity-50">
        <div className="absolute left-[14%] top-[18%] h-80 w-80 rounded-full bg-white/5 blur-3xl" />
        <div className="absolute right-[18%] bottom-[16%] h-96 w-96 rounded-full bg-[#d4af37]/10 blur-3xl" />
      </div>
